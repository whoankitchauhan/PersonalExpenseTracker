...
public class ExpenseManager {
    ...
    public static void viewMonthlySummaryUsingView(String username) {
        String sql = "SELECT month, total_spent FROM monthly_spending_summary WHERE username = ? ORDER BY month DESC";
        ...
        try (Connection conn = DBConnection.getConnection();
            ...
            System.out.println("\n--- Monthly Spending Summary (from View) ---");
            while (rs.next()) {
                String month = rs.getString("month");
                double total = rs.getDouble("total_spent");
                System.out.println("Month: " + month + " | Total Spent: " + total);
            }
